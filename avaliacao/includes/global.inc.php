...
function pt_register(){
	...
	if($num_args >= 2){
		...
		if($method == 'POST'){
			...
			$urloficial		= 'http://www.cartoriopostal.com.br/avaliacao';
			$urloficial2	= 'https://www.cartoriopostal.com.br/avaliacao';
			$urlanterior2	= substr($urlanterior, 0, strlen($urloficial2));
			$urlanterior	= substr($urlanterior, 0, strlen($urloficial));
			$ip				= getenv("REMOTE_ADDR");
				if($urlanterior!=$urloficial and $urlanterior2!=$urloficial2 and $urlanterior<>'' and $_SERVER['SERVER_NAME']=='www.cartoriopostal.com.br/avaliacao'){
