		...
		<div class="pages">
			...
			<table width="1000" class="table_info">
							...
							<td align="left" valign="top" class="td_info">
								<ul id="lista">
									<li>
										...
										if($permissao == 'TRUE'){
										?>
										<a href="area-pretendida-add.php" title="Clique aqui" class="link_lista">Cadastro: Nova área</a>
										<?}?>
									</li>
								</ul>
							</td>
				...
				<form name="form" action="" method="GET" enctype="multipart/form-data">
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2"><label for="busca_dados" accesskey="1">Busca (ID / Nome da área)</label></td>
			...
			<table width="1000" class="table_list">
				<tr>
					...
					<td width="800" align="left" valign="middle">Nome da área</td>
