	...
	<div class="conteudo">
		...
		<div class="pages">
			...
			<table width="1000" class="table_list">
				...
				$condicao = "FROM cp_news_nova as ns, cp_comentario_news as cm, cp_status as st WHERE cm.st_id=st.st_id AND ns.id_news=cm.id_news " .$onde. " ORDER BY cm.id_comentario DESC";
				$campo = "ns.id_news, ns.titulo_news, cm.id_comentario, cm.nome, cm.email, date_format(cm.data, '%d/%m/%Y') as data, cm.st_id, st.st_id, st.status";
