		...
		if(isset($_POST['acao']) && $_POST['acao']=="cadastrar"){
			if(isset($_FILES['cat_imagem']) && $_FILES['cat_imagem']['name'] != null){
				...
				for($i = 0; $i < count($images); $i++){
					...
					if(count($errors)<1){
						$query="INSERT INTO cp_parcerias (";
			...
			<table width="1000" class="table_info">
				...
				<form name="form" action="" method="post" enctype="multipart/form-data">
					...
					<table width="100%">
						...
						<tr>
							<td width="50%"><label for="nome_imagem" accesskey="1">Nome da parceria</label></td>
				...
				if($done){
					...
					echo '<meta HTTP-EQUIV="refresh" CONTENT="2; URL=parcerias-add.php" />';
				}
				?>
				</td>
				<tr>
