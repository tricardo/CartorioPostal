			...
			<table width="1000" class="table_info">
				...
				<form name="form" action="" method="post" enctype="multipart/form-data">
					...
					<table width="100%">
						...
						<tr>
							<td width="50%"><label for="nome_imagem" accesskey="1">Nome do produto</label></td>
				...
				if($done){
					...
					echo '<meta HTTP-EQUIV="refresh" CONTENT="2; URL=produtos-add.php" />';
				}
				?>
				</td>
				<tr>
