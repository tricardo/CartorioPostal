...
if($submit1){
	$errors=array();
		if($total=="" || $total==""){
			if($total=="")	$errors['total']=1;
				$error.="<span style='color:#FF0000;'>O(s) campo(s) vermelho obrigatórios.</span><br />";
		}
		if(count($errors)<1){
			$query="INSERT INTO cp_unidades (id_usuario, total) values ('".$cp_id_usuario."','".$total."')";
			...
			<table width="1000" class="table_info">
				...
				<td align="center" valign="top" class="td_info">
					...
					<table width="100%">
						...
						<tr>
							<?
							$permissao = verifica_permissao('lista_unidades',$cp_permissao_p,$cp_permissao_s);
							if($permissao == 'TRUE'){
							?>
							<td align="center" valign="top" class="td_info">
							...
							<td align="left" valign="top" class="td_info">
								<ul id="lista">
									<li>
										...
										if($permissao == 'TRUE'){
										?>
										<a href="unidades-list.php" title="Clique aqui" class="link_lista">Lista: Unidades</a>
										<?}?>
									</li>
								</ul>
							</td>
				...
				<form name="form" action="" method="post" enctype="multipart/form-data">
					...
					<table width="100%">
						<tr>
							<td><label for="total" accesskey="1">Unidade</label></td>
						</tr>
						<tr>
							<td><input name="total" type="text" id="total" value="<?= $total?>" <?=($errors['total'])?'style="border:1px solid #FF0000;"':''; ?> /></td>
						</tr>
						<tr>
				...
				if($done){
					...
					echo '<meta HTTP-EQUIV="refresh" CONTENT="2; URL=unidades-add.php" />';
				}
				?>
				</td>
				<tr>
