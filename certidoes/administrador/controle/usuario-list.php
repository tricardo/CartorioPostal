		...
		<div class="pages">
			...
			<table width="1000" class="table_info">
							...
							<td align="left" valign="top" class="td_info">
								<ul id="lista">
									<li>
										...
										if($permissao == 'TRUE'){
										?>
										<a href="usuario-add.php" title="Clique aqui" class="link_lista">Cadastro: Usuários</a>
										<?}?>
									</li>
								</ul>
							</td>
				...
				<form name="form" action="" method="GET" enctype="multipart/form-data">
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2"><label for="busca_dados" accesskey="1">Busca (ID / Usuário / E-mail)</label></td>
			...
			<table width="1000" class="table_list">
				<tr>
					...
					<td width="360" align="left" valign="middle">Usuário</td>
					...
					if($permissao == 'TRUE'){
					?>
					<td width="40" align="center" valign="middle">Permissão</td>
					<?}?>
					<?
