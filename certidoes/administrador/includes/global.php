...
function pt_register(){
	...
	if($num_args >= 2){
		...
		if($method == 'POST'){
			...
			$urloficial		= 'http://www.canaldosprofissionais.com.br';
			$urloficial2	= 'https://www.canaldosprofissionais.com.br';
			$urlanterior2	= substr($urlanterior, 0, strlen($urloficial2));
			$urlanterior	= substr($urlanterior, 0, strlen($urloficial));
			$ip				= getenv("REMOTE_ADDR");
				if($urlanterior!=$urloficial and $urlanterior2!=$urloficial2 and $urlanterior<>'' and $_SERVER['SERVER_NAME']=='www.canaldosprofissionais.com.br'){
