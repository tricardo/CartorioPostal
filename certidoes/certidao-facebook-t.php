...
if ($submit_pedido <> '') {//check for errors
    ...
    if (count($errors) < 1) {
        if ($_SESSION['id_pedido'] == '') {
            ...
            $res = $pedidoDAO->selectEmpresaCEP($cep);
...
<div style="width: 790px;">
<form name="form_orcamento1" action="" method="post" enctype="multipart/form-data">
    <table border="0" width="100%" align="center" cellpadding="3" cellspacing="3">
        <tr>
            <td colspan="5">
        ...
        <tr>
            ...
            <input type="text" name="cpf" value="<?= $p->cpf ?>" style="width: 200px;" onKeyUp="if(tipo.value=='cpf') masc_numeros(this,'###.###.###-##'); else masc_numeros(this,'##.###.###/####-##');" <?= ($errors['cpf']) ? 'style="border: 1px solid #FF0000; width: 100%; height: 20px;"' : ''; ?> />
            </td>
        ...
        <tr>
            ...
            <td><input type="text" name="tel" id="tel" value="<?= $p->tel ?>" onKeyUp="masc_numeros(this,'(##) ####-####');" <?= ($errors['tel']) ? 'style="border: 1px solid #FF0000; width: 100%; height: 20px;"' : ''; ?>/></td>
        ...
        <tr>
            ...
            <td><input type="text" name="outros" id="outros" value="<?= $p->outros ?>" onKeyUp="masc_numeros(this,'(##) ####-####');" <?= ($errors['outros']) ? 'style="border: 1px solid #FF0000; width: 100%; height: 20px;"' : ''; ?> /></td>
            <td><label for="tel2">Celular:</label><strong style="color: #FF0000;"></strong></td>
            <td><input type="text" name="tel2" id="tel2" value="<?= $p->tel2 ?>" onKeyUp="masc_numeros(this,'(##) ####-####');" <?= ($errors['tel2']) ? 'style="border: 1px solid #FF0000; width: 100%; height: 20px;"' : ''; ?> /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td> <input type="text" name="cep" id="cep" value="<?= $p->cep ?>" onKeyUp="masc_numeros(this,'#####-###');" <?= ($errors['cep']) ? 'style="border: 1px solid #FF0000; width: 100%; height: 20px;"' : ''; ?> /></td>
        ...
        <tr>
            ...
            $java_script = '';
            $p_valor .= '<select name="' . $servicocampo->campo . '" style="width:540px" ' . $java_script . ' style="border: 1px solid #FF0000; width: 100%; height: 20px;">
