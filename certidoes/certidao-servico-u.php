	...
	*/
    ...
    if (count($errors) < 1) {
        if ($_SESSION['id_pedido'] == '') {
			...
			$res = $pedidoDAO->SelectEmpresaId(1);
		...
		$msg .= "<br />";
		$msg .= "<strong>Número da Ordem:</strong> ".$cadastrar_pedido;
                ...
                <? if ($_SESSION['id_pedido'] == '') { ?>
                    ...
                    <? } else { ?>
                        <p><strong>Prezado(a) <?= $p->nome ?>, </strong><br />
                            ...
                            <strong>Para solicitar um novo serviço, preencha os campos abaixo, caso contrário <a href="<?= URL_SITE; ?>parceria-unilever-certidao.php?p_novo=1">clique aqui!</a></strong>
                        </p>					
