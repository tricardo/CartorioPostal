...
<div id="container">
    <div class="box_f">
        <div id="coluna_e">
            <div class="box_h">
                <h1 style="color: #202A72;">CONHEÇA AS UNIDADES DA CARTÓRIO POSTAL NA REGIÃO SUDESTE</h1>
                ...
                <img src="<?= URL_IMAGES;?>pages/conheca-as-unidades-da-cartorio-postal-na-regiao-sudeste.png" alt="conheca as unidades da cartorio postal na região sudeste" title="Conheça as unidades da Cartório Postal na Região Sudeste" style="margin: 5px 0 20px 0;" />
                        ...
                        <tr>
                            <td>
                                <select name="fale_estado" id="fale_estado" onChange="carrega_cidades(this.value,'');">
                                    ...
                                    $lista = $servicoDAO->listaRegiaoSudeste();
                                    $p_valor = '';
                                    foreach ($lista as $l){
