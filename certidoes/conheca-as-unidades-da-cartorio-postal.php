...
<div id="container">
    <div class="box_f">
        <div id="coluna_e">
            <div class="box_h">
                <h1 style="color: #202A72;">CONHEÇA AS UNIDADES DA CARTÓRIO POSTAL</h1>
                ...
                <img src="<?= URL_IMAGES;?>pages/as-unidades-da-cartorio-postal.png" alt="conheca as unidades da cartorio postal" title="Conheça as unidades da Cartório Postal" style="margin: 5px 0 20px 0;" />
                <strong style="font-size: 15px; color: #202A72;">ESCOLHA SUA REGIÃO E VISITE NOSSA LOJA MAIS PRÓXIMA DE VOCÊ</strong>
                <div class="faixa_h"></div>
