...
<div id="container">
    <div class="box_f">
        <div id="coluna_e">
            <div class="box_h">
                <h1 style="color: #202A72;">CONHEÇA AS UNIDADES DO EXTERIOR DA CARTÓRIO POSTAL</h1>
                ...
                <img src="<?= URL_IMAGES;?>pages/conheca-as-unidades-do-exterior-da-cartorio-postal-1.png" alt="conheca as unidades da cartorio postal no exterior" title="Conheça as unidades da Cartório Postal no Exterior" style="margin: 5px 0 20px 0;" />
                        ...
                        <tr>
                            <td>
                                <select name="fale_estado" id="fale_estado" onChange="carrega_cidades(this.value,'');">
                                    ...
                                    $lista = $servicoDAO->listaExterior();
                                    $p_valor = '';
                                    foreach ($lista as $l){
