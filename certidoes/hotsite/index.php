				...
				<div class="nav-02">
					<table width="100%" border="0" align="center" cellspacing="5" cellpadding="5" bgcolor="#FFFFFF">
						...
						<tr>
							...
							$condicao = "FROM cartorio_banco2.vsites_user_empresa as ue, cp_produtos as ps WHERE '".$fr->id_empresa."'=ps.id_empresa AND ps.st_id='1' AND ps.destaque='1' AND ue.id_empresa='".$fr->id_empresa."' ORDER BY RAND()";
							$campo = "'".$fr->id_empresa."', ps.id_produtos, ps.nome_imagem, ps.destaque, ps.cat_imagem, ps.destaque, ps.st_id";
						...
						<tr>
							<td align="right" valign="middle" bgcolor="#FFFFFF" colspan="3">
								<a href="/<?= $fr->id_empresa ?>/<?= $fr->link_estado ?>/<?= $fr->link_cidade ?>/produtos-e-servicos" title="Clique aqui para conhecer todos nossos produtos e serviços"><img src="<?= URL_IMAGES;?>pages/ver-todos.png" alt="Clique aqui para conhecer todos nossos produtos e serviços" title="Clique aqui para conhecer todos nossos produtos e serviços" /></a>
								<div class="faixa"></div>
							</td>
						</tr>
					</table>
					...
					<table width="100%" border="0" align="left" cellspacing="5" cellpadding="5" bgcolor="#FFFFFF">
						...
						<tr>
							<td align="right" valign="middle">
								<a href="/<?= $fr->id_empresa ?>/<?= $fr->link_estado ?>/<?= $fr->link_cidade ?>/galeria-de-fotos" title="Clique aqui para acessar nossa galeria de fotos"><img src="<?= URL_IMAGES;?>pages/ver-todos.png" alt="Clique aqui para acessar nossa galeria de fotos" title="Clique aqui para acessar nossa galeria de fotos" /></a>
								<div class="faixa"></div>
							</td>
						</tr>
					</table>
