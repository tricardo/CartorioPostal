...
//error_reporting(0);
set_time_limit(0);
include("../includes/maladireta/config.inc.php");
include("../includes/maladireta/class.Email.php");
error_reporting(1);

$name_sender 	= 'Softfox - Soluções para Web';
$email_sender 	= 'suporte@softfox.com.br';
