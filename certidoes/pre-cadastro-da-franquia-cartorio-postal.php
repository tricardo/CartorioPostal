    ...
    <div class="box_f">
        <div id="coluna_e">
			...
			$query.= "'".$estado."','".$cidade."','".$observacao."','Pendente',NOW(),1)";
                        ...
                        $id = $objQuery->ID;
                        $query = "INSERT INTO site_ficha_cadastro_historico (id_ficha, id_user_alt, id_status, 
							forma_pagto, data_reuniao, data_inclusao, observacao) 
							VALUES (".$id.", 0, 1, 0, '', date('Y-m-d H:i:s'), 'cadastrado')";
			...
			$message->Send();
                                            ...
                                            <div id="apDiv-ficha">
                                                ...
                                                <tr>
                                                    <td colspan="3" align="center" valign="top">
                                                       <a href="#" onclick="fecharFicha()"><img src="'.URL_IMAGES.'pages/image-bt-fechar.png" alt="Clique aqui para fechar este informativo." title="Clique aqui para fechar este informativo." /></a>
                                                    </td>
                                                </tr>
                                                </table>
                                            </div>
                ...
                if($done){
                    ...
                    echo '<meta HTTP-EQUIV="refresh" URL='.URL_SITE.'agradecimentos.php">';
                }
                ?>
            </div>
            <div class="box_c">
