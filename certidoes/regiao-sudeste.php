...
<div id="container">
    ...
    <div id="contant">
        ...
        <div id="texto">
            ...
            <br /><strong style="font-size: 15px; color: #202A72;">REGIÃO SUDESTE</strong>
            <div class="faixa_h"></div>
