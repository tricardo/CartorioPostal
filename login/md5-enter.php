...
#mainContent { width:955px; background-image:url(images/header3.png); background-repeat:repeat; float:left; }
#marca { 
	width:955px; 
	text-align:center; 
...
input { border:solid 1px #666666; margin-top:7px; }
select { border:solid 1px #666666; margin-top:7px; width:222px; }
#login { width:286px; margin-left:335px; margin-top:15px; }
#login label { text-transform:uppercase; font-weight:bold; width:60px; display:inline-block; margin-top:7px; }
#login input[type="text"] { width:220px; }
...
<body>
<form method="post" action="md5-enter.php">
<div id="container">
	<div id="header"></div>
    <div id="mainContent">
    	<div id="marca">
    ...
    <div id="footer">
        ...
        Copyright© 2009. Cartório Postal. Todos os Direitos Reservados. <strong><a href="#">Política de Privacidade</a></strong> <br />
        Desenvolvido por <strong><a href="http://www.canaldosprofissionais.com.br" target="_blank">CANAL DOS PROFISSIONAIS</a></strong>
    </div>
</div>
</form>
</body>
