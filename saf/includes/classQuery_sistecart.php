<?
	class classQuery_sistecart{
		...
		function paginacao( $campo, $condicao, $pagina="", $link, $maximo=14){
			$campos_query = $campo;
	...
	$objQuery_sistecart = new classQuery_sistecart();
?>