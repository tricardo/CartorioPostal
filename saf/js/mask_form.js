$(document).ready(function(){
	...
	$("#tel_cont").mask("(99) 9999.9999");//Telefone contato
	...
	$("#data_saida").mask("99/99/9999");//Data de Nascimento
	$("#data_retorno").mask("99/99/9999");//Data de Nascimento
	$("#data_evento").mask("99/99/9999");//Data do evento
	$("#busca_data").mask("99/99/9999");//Data de Nascimento
	$("#horario_saida").mask("99:99");//Horário de Nascimento
	$("#horario_retorno").mask("99:99");//Horário de Nascimento
