...
<td width="764" align="center" valign="top" background="../images/paginas/index/barra_de_titulo1.png">
	<table width="768" border="0" cellspacing="0" cellpadding="0">
	<tr>
	<td width="345" height="20" align="left" valign="middle"><strong>Mala Direta: Franchise Emporium</strong></td>
...
<td>
    <div id="conteudo">
			...
			if ($submit1){
				...
				$Sender = "Mala Direta <jefferson.ramirez@franchiseemporium.com.br>";
