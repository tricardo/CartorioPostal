<form name="form_interesse" action="interessados_edit.php?id=<?=$id?>&aba=3" method="post">
	<? if($errors > 0){ ?>
	<div style="color:#FF0000; border:solid 1px #0071B6; border-top:none; width:756px; margin:10px;">
		<p><?= $error ?></p>
	</div><? }?>
	<div id="dados_administrativos" class="div_titulo" style="width:756px;">&nbsp;- Aprovar Cadastro
	<img src="../images/null.gif" onload="javascript:document.getElementById('frm').src='busca_cep.php';" /></div>
	<div class="div_form" style="width:756px;">
		...
		<p style="text-transform:none; font-weight:normal; margin-bottom:0; width:756px; float:left">
