			...
			<div class="div_form">
				<div id="informativo">
					...
					<label style="margin-left:71px;"><strong>N.º COF:</strong></label>
					<label style="margin-left:113px;"><strong>Valor da COF:</strong></label>
					<label style="margin-left:72px;"><strong>Forma de Pagto.: <span>*</span></strong></label><br />
					...
					<label style="margin-left:53px;"><strong>Valor Efetivo da Franquia: <span>*</span></strong></label><br />
