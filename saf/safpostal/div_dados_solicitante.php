				<div>
					...
					<label style="margin-left:318px;"><strong>RG: <span>*</span></strong></label>
					...
					<label style="margin-left:210px;"><strong>E-mail: <span>*</span></strong></label><br />
					...
					<label style="margin-left:144px;"><strong>Recado:</strong></label>
					...
					<label style="width:758px;">&nbsp;</label>
					<label style="margin-left:10px;"><strong>Operadora: </strong></label>
					<label style="margin-left:165px;"><strong>Nacionalidade: <span>*</span></strong></label>
					<label style="margin-left:120px;"><strong>Local de Nascimento:</strong></label><br />
					<select name="id_operadora" id="id_operadora" class="form_estilo" style="width:232px; margin-left:10px;" >
						<option value="">---</option>
						<?
						$FichaDAO = new FichaDAO();
						$lista = $FichaDAO->listaOperadora();
						$p_valor = '';
						foreach ($lista as $l){
					...
					<input name="nacionalidade" type="text" class="form_estilo" id="nacionalidade" style="width:232px; margin-left:11px;" value="<?=$c->nacionalidade?>" maxlength="50" />
					<input name="local_nascimento" type="text" class="form_estilo" id="local_nascimento" style="width:232px; margin-left:11px;" value="<?=$c->local_nascimento?>" maxlength="50" />
					...
					<label style="margin-left:75px;"><strong>Quantos?</strong></label><br />
					...
					<label style="margin-left:215px;"><strong>Data do Casamento:</strong></label><br />
					...
					<label style="margin-left:280px;"><strong>Nome da Mãe:</strong></label><br />
					...
					<label style="margin-left:262px;"><strong>Profissão: <span>*</span></strong></label><br />
