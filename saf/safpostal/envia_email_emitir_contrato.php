...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="600" style="font-weight:bold">
        ...
        <p class="topo2">Franquia: '.$safpostal_fantasia.'</p>
        <hr />
        <p class="id">Emitir Contrato</p></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="150" height="25"><strong>Nome do Candidato:</strong></td>
        <td>'.$c->nome.'</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="25"><strong>Forma de Pagamento:</strong></td>
        <td>'.$c->forma_pagto .'</td>
      </tr>
      <tr>
        <td height="25"><strong>Nome do S&oacute;cio:</strong></td>
        <td>'.$c->nome_socio.'</td>
      </tr>
      <tr>
	  ...
	  <tr>
	    <td colspan="2" style="color:#FF0000;">* Os dados acima s&atilde;o para a emiss&atilde;o do contrato.</td>
	  </tr>
    </table></td>
    <td>&nbsp;</td>
  </tr>
...
$Sender = "Cartorio Postal - SAF <expansao@cartoriopostal.com.br>";
