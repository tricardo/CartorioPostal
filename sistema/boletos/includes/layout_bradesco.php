...
<table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD class=ct width=666><img height=1 src=../boletos/imagens/6.png width=665 border=0></TD></TR><TR><TD class=ct width=666>
<div align=right><b class=cp>Recibo do Sacado</b></div></TD></tr></tbody></table>
...
<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
  <span class="campo"><IMG 
      src="../boletos/imagens/logobradesco.jpg" width="150" height="40" 
      border=0></span></td>
...
</tr><tbody><tr><td colspan=5><img height=2 src=../boletos/imagens/2.png width=666 border=0></td></tr></tbody></table>
<table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=../boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=472 height=13>Local 
de pagamento</td>
...
<tr><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=472 height=12>
...
do documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=../boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=153 height=13>N<u>o</u> 
...
<img height=13 src=../boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=82 height=13>Data 
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left> 
  ...
  </span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=153 height=12> 
    <span class="campo">
 ...
 </div></td><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=82 height=12><div align=left> 
   <span class="campo">
...
<img height=1 src=../boletos/imagens/2.png width=7 border=0></td><td valign=top width=153 height=1><img height=1 src=../boletos/imagens/2.png width=153 border=0></td><td valign=top width=7 height=1> 
...
<img height=1 src=../boletos/imagens/2.png width=7 border=0></td><td valign=top width=82 height=1><img height=1 src=../boletos/imagens/2.png width=82 border=0></td><td valign=top width=7 height=1> 
<img height=1 src=../boletos/imagens/2.png width=7 border=0></td><td valign=top width=180 height=1> 
<img height=1 src=../boletos/imagens/2.png width=180 border=0></td></tr></tbody></table>
<table cellspacing=0 cellpadding=0 border=0><tbody>
<tr> 
<td class=ct valign=top height=13 width=7> <img height=13 src=../boletos/imagens/1.png width=1 border=0></td>
<td class=ct valign=top height=13 width=70>Uso do banco</td>
<td class=ct valign=top height=13 width=7> <img height=13 src=../boletos/imagens/1.png width=1 border=0></td>
<td class=ct valign=top height=13 width=10>Cip</td>
<td class=ct valign=top height=13 width=7> <img height=13 src=../boletos/imagens/1.png width=1 border=0></td>
<td class=ct valign=top height=13 width=83>Carteira</td>
<td class=ct valign=top height=13 width=7> <img height=13 src=../boletos/imagens/1.png width=1 border=0></td>
...
<tr> 
<td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td>
<td class=ct valign=top height=12 width=70></td>
<td class=ct valign=top height=12 width=7> <img height=12 src=../boletos/imagens/1.png width=1 border=0> </td>
<td class=ct valign=top height=12 width=10></td>
<td class=ct valign=top height=12 width=7> <img height=12 src=../boletos/imagens/1.png width=1 border=0></td>
<td class=cp valign=top  width=83> 
<div align=left> <span class="campo">
  <?php echo $dadosboleto["carteira"]?>
</span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=53><div align=left><span class="campo">
<?php echo $dadosboleto["especie"]?>
</span> 
 </div></td><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=123><span class="campo">
 <?php echo $dadosboleto["quantidade"]?>
 </span> 
 </td>
 <td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=72> 
   <span class="campo">
...
<img height=1 src=../boletos/imagens/2.png width=7 border=0></td><td valign=top width=53 height=1><img height=1 src=../boletos/imagens/2.png width=53 border=0></td><td valign=top width=7 height=1> 
<img height=1 src=../boletos/imagens/2.png width=7 border=0></td><td valign=top width=123 height=1><img height=1 src=../boletos/imagens/2.png width=123 border=0></td><td valign=top width=7 height=1> 
<img height=1 src=../boletos/imagens/2.png width=7 border=0></td><td valign=top width=72 height=1><img height=1 src=../boletos/imagens/2.png width=72 border=0></td><td valign=top width=7 height=1> 
...
(Texto de responsabilidade do cedente)</font>
<br><span class=cp>*** VALORES EXPRESSOS EM REAIS *** <br><br><FONT class=campo>
...
</table></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0><tbody><tr><td valign=top width=666 height=1><img height=1 src=../boletos/imagens/2.png width=666 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=../boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=659 height=13>Sacado</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=659 height=12><span class="campo">
<?php echo $dadosboleto["sacado"].' - CNPJ/CPF: '.$dadosboleto["cpf"] ?>
</span> 
</td>
</tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=659 height=12><span class="campo">
<?php echo $dadosboleto["endereco1"]?>
</span> 
</td>
</tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=../boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=472 height=13> 
  <span class="campo">
...
mecânica - <b class=cp>Ficha de Compensação</b></div></TD></TR><TR><TD class=ct  colspan=3 ></TD></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=ct width=666></td></tr><tbody><tr><td class=ct width=666> 
<div align=right>Corte na linha pontilhada</div></td></tr>
<tr><td class=ct width=666><img height=1 src=../boletos/imagens/6.png width=665 border=0></td></tr></tbody></table><br>
...
<tr><td colspan=5><img height=2 src=../boletos/imagens/2.png width=666 border=0></td></tr></tbody></table>
<table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=../boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=472 height=13>Local 
de pagamento</td>
<td class=ct valign=top width=7 height=13><img height=13 src=../boletos/imagens/1.png width=1 border=0></td>
<td class=ct valign=top width=180 height=13>Vencimento</td>
...
<span class=cp> <FONT class=campo>*** VALORES EXPRESSOS EM REAIS ***
<br><br>
<?php echo $dadosboleto["instrucoes1"]; ?><br>
<?php echo $dadosboleto["instrucoes2"]; ?><br>
<?php echo $dadosboleto["instrucoes3"]; ?><br>
