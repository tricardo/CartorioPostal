<?
	...
	<table width="800" class="tabela">
			...
			<tr>
				...
				<td>
					<div style="width: 150px" class="form_estilo">
						<input type="checkbox" <? if($p->restricao=='on') echo 'checked="checked"'; ?> name="restricao" /> <strong>Tem restrição</strong>
					</div>
				</td>
				<td></td>
				<td>
			...
			<tr>
				...
				<td>
				<select name="forma_pagamento" style="width: 150px" class="form_estilo <?=($errors['forma_pagamento'])?'form_estilo_erro':''; ?>" onchange="javascript:if(this.value=='Depósito'){ document.getElementById('tr_dados_bancarios').style.visibility='visible'; } else { document.getElementById('tr_dados_bancarios').style.visibility='hidden'; dados_bancarios.value=null; }">
						<option value=""></option>
						<?
							$p_valor = "";
			...
			<tr id="tr_dados_bancarios" style="<? if($p->forma_pagamento!='Depósito') echo "visibility:hidden";?>">
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td colspan="3">
					...
					<div style="width: 230px; float:left; margin-left:5px; ">
						<input	type="checkbox" <? if($p->omesmo=='on') echo 'checked="checked"'; ?> onchange="javascript:faturar_mesmoendereco_edit(this.checked);" name="omesmo" /> <strong>Faturar para o mesmo endereço</strong>
					</div>
					</td>
			</tr>
			<tr>
