...
class RelatorioDAO extends Database{
	...
	/**
	 * registra a geração de um relatório, com o id da empresa e o nome do arquivo (com o diretório)
	 *
	...
	/**
	 * registra a geração de um relatório do mes anterior, com o id da empresa e o nome do arquivo (com o diretório)
	 *
	 * @param int $id_empresa
	 * @param String $arquivo
	 * @param String $rel
	...
	/**
	 * busca dados para relatório de Royalties
	 * @param int $id_empresa
	 * @param Strnig $data
	 */
	...
	public function listaRoyaltiesAnual($ano){
		...
		WHERE  e.id_empresa !=1 and r.data>=? AND r.data<=?
		GROUP BY e.id_empresa, date_format( r.data, '%Y-%m' ) ORDER BY e.fantasia, r.data";		
