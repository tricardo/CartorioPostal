...
if ($submit) {//check for errors
    ...
    if (count($errors) == 0) {
        ...
        if ($done) {
            //alterado 01/04/2011
            $titulo = 'Adicionar Agência dos Correios';
            $perg = 'Novo registro adicionado com sucesso!\nAdicionar outro?';
            $resp1 = 'correio_add.php';
            $resp2 = 'correios.php';
                    ...
                    <form enctype="multipart/form-data" action="" method="post" name="correio_add">
                        <table width="650" class="tabela">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" name="nome" value="<?= $nome ?>" style="width: 460px" class="form_estilo <?= (isset($errors['nome'])) ? 'form_estilo_erro' : ''; ?>">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" name="data_cartaz" onKeyUp="masc_numeros(this,'##/##/####');" value="<?= $data_cartaz ?>" style="width: 150px" class="form_estilo" />
                                    (Opcional)
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" name="endereco" value="<?= $endereco ?>" style="width: 460px" class="form_estilo" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" name="bairro" value="<?= $bairro ?>" style="width: 150px" class="form_estilo" />
                                </td>
                                <td>
                                    <div align="right"><strong>Cidade: </strong></div>
                                </td>
                                <td>
                                    <input type="text" name="cidade" value="<?= $cidade ?>" style="width: 200px" class="form_estilo">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" name="estado" value="<?= $estado ?>" style="width: 150px" class="form_estilo" />
                                </td>
                                <td>
                                    <div align="right"><strong>CEP: </strong></div>
                                </td>
                                <td>
                                    <input type="text" name="cep" value="<?= $cep ?>" onKeyUp="masc_numeros(this,'#####-###');" style="width: 200px" class="form_estilo">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" name="tel" value="<?= $tel ?>" onKeyUp="masc_numeros(this,'## ####-####');" style="width: 150px" class="form_estilo" />
                                </td>
                                <td>
                                    <div align="right"><strong>Fax: </strong></div>
                                </td>
                                <td>
                                    <input type="text" name="fax" value="<?= $fax ?>" onKeyUp="masc_numeros(this,'## ####-####');" style="width: 200px" class="form_estilo">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="4">
                                    <div align="center">
                                        <input type="submit" name="submit" value="Adicionar" class="button_busca" />&nbsp; 
