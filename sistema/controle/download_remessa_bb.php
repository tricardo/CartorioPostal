...
$arq = $contaDAO->selectArquivoBBPorId($id,$controle_id_empresa);
...
header ("Content-disposition: attachment; filename=".str_replace('../boletos/remessabancodobrasil/','',$arq->arquivo).";");
