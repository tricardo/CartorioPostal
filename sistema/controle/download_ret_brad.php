...
$arq = $contaDAO->selectArquivoRetPorId($id,$controle_id_empresa);
...
header ("Content-disposition: attachment; filename=".str_replace('../boletos/retornobradesco/','',$arq->arquivo).".txt;");
