...
if($exp_item->acesso == 0) { 
	echo '<br><br><br><br><strong>Você não tem permissão para acessar essa página</strong>';
	require('footer.php');
	exit;
} ?>
<div id="topo">
	...
	<table style="width:670px;float:left;margin-top:-22px;margin-left:200px;">
		<tr>
			...
			<td style="width:20px;text-align:center;font-weight:bold">|</td>
			<td style="text-align:center"><a style="text-decoration:none;font-weight:bold" href="../expansao/relatorio.php" target="expansao_frame" onclick="$('#titulo_pagina').html('Relatório')">Relatório</a></td>
			<!--<td style="width:20px;text-align:center;font-weight:bold">|</td>
