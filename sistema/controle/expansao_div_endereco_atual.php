				<div>
					...
					<label style="margin-left:278px;"><strong>Nº.: <span>*</span></strong></label>
					<label style="margin-left:50px;"><strong>Complemento:</strong></label>
					<label style="margin-left:19px;"><strong>Bairro: <span>*</span></strong></label><br />
					...
					<label style="margin-left:71px;"><strong>Cidade: <span>*</span></strong></label>
					<label style="margin-left:393px;"><strong>CEP: <span>*</span></strong></label><br />
					...
					<label style="margin-left:268px;"><strong>Reside na Praça Desde:</strong></label><br />
