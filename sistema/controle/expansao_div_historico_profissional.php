				<div>
					...
					<label style="margin-left:305px;"><strong>Cargo Atual: <span>*</span></strong></label><br />
					...
					<label style="margin-left:182px;"><strong>Funcionários:</strong></label>
					<label style="margin-left:155px;"><strong>Faturamento:</strong></label><br />
					...
					<label style="margin-left:180px;"><strong>Ramo de Atuação:</strong></label>
					<label style="margin-left:130px;"><strong>Nome da Empresa:</strong></label><br />
					...
					<label style="margin-left:313px;"><strong>Grau de Escolaridade:</strong></label><br />
					...
					<label style="margin-left:180px;"><strong>Ano de Conclusão:</strong></label>
