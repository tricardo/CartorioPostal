...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="600" style="font-weight:bold">
        ...
        <p class="topo2">Franquia: '.utf8_encode($controle_fantasia).'</p>
        <hr />
  ...
  <tr>
    ...
    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="2">Caro Administrador, você deve acessar o sistema do Sistecart e finalizar o processo
...
$Sender = "Cartório Postal - Expansão <expansao@cartoriopostal.com.br>";
...
$From = 'Sistema Expansao - Finalizar Processo';
$AddAddress = 'ti@cartoriopostal.com.br';
$Subject = 'Expansao - Finalizar Processo';
