...
if($controle_id_usuario != $c->id_usuario){
	if($controle_id_usuario != 1 && $controle_id_usuario != 56 && $controle_id_usuario != 2360){
		echo '<br><br><br><br><span style="color:#FF0000">Você não tem permissão para visualizar esta página.</span>';
		exit();
	}
}?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td rowspan="7">&nbsp;</td>
    <td height="30" align="center" valign="top" width="960">&nbsp;</td>
    <td rowspan="7">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right" height="70"><a href="javascript:self.print()"><img src="../images/botoes/imprimir.png" hspace="2" style="width:50px; height:50px;" /></a></td>
  </tr>
</table>
</body>
</html>