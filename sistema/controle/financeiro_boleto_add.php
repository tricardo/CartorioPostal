...
<table width="670" class="tabela">
	...
	<tr>
		<td>
			<form method="POST" action=""  class="form_auto" name="form_auto" id="form_auto" enctype="multipart/form-data">
				...
				<input type="text" id="id_fatura" maxlength="10" name="id_fatura" value="<?= $p->id_fatura ?>"  onKeyUp="masc_numeros(this,'##########');" class="form_estilo<? if($errors['id_fatura']==1) echo '_erro' ?>" style=" width:140px; " />

				<label for="nota">Nota: </label>
				<input type="text" id="id_nota" maxlength="10" name="id_nota" value="<?= $p->id_nota ?>"  onKeyUp="masc_numeros(this,'##########');" class="form_estilo<? if($errors['id_nota']==1) echo '_erro' ?>" style=" width:100px; " />
 ...
 class="form_estilo<? if($errors['valor']==1) echo '_erro' ?>" style=" width:120px; " /><div class="asterisco">*</div>
				...
				<select name="ocorrencia" id="ocorrencia"  class="form_estilo_r" readonly  style=" width:338px; ">
				<option value="1" selected="select">Remessa</option>

				</select><div class="asterisco">*</div>
				
				<label for="instrucao1">Instrução 1: </label>
				<select name="instrucao1" id="instrucao1" onchange="if(instrucao1.value!=6) instrucao2.value=''; else instrucao2.value=5;"  class="form_estilo<? if($errors['instrucao1']==1) echo '_erro' ?>" style=" width:552px; ">
				<option value="" ></option>
				...
				<option value="11"<? if($p->instrucao1=='11') echo 'selected="select"'; ?>>Não receber após o 8º dia do vencimento</option>
				<option value="12"<? if($p->instrucao1=='12') echo 'selected="select"'; ?>>Cobrar encargos após o 5º dia do vencimento</option>
				<option value="13"<? if($p->instrucao1=='13') echo 'selected="select"'; ?>>Cobrar encargos após o 10º dia do vencimento</option>
				<option value="14"<? if($p->instrucao1=='14') echo 'selected="select"'; ?>>Cobrar encargos após o 15º dia do vencimento</option>
				</select><div class="asterisco">&nbsp;</div>
