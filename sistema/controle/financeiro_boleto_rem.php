...
?>
<div id="topo">
	<h1 class="tit"><img src="../images/tit/tit_rel_banco.png" alt="Título" />Gera Remessa Bradesco</h1>
	...
	<tr>
		...
		<table width="650" class="tabela">
			...
			<tr>
				...
				if($submit<>''){
					require('../boletos/gerabradesco.php');
				}
			...
			<tr>
				...
				<td colspan="3"><input type="file" name="file_import" style="width: 200px" value="<?= $file_import ?>" class="form_estilo" /> Opção disponível apenas para Bradesco</td>
			</tr>
			<tr>
				<td colspan="4">
			...
			while($res = mysql_fetch_array($sql)){
				$p_valor .= '
					<tr>
						...
						<td class="result_celula"> <a href="download_remessa_brad.php?id='.$res['id_bradesco_rem'].'">'.str_replace('../boletos/remessabradesco/','',$res['arquivo']).'</a></td>
					</tr>';
			}
			echo $p_valor;
			?>
