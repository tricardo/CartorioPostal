...
$arquivoConteudo  = 'Relatório de ;Desembolso por franquia ; Comissionamento de 14%; 
';
if($enviados<>'') 
...
';
			...
			$banco='';		
			if($enviados<>'') $onde = " u2.id_empresa != '".$controle_id_empresa."' and u.id_empresa='".$controle_id_empresa."' and pi.id_empresa_resp <> '' and pi.id_empresa_resp=ue.id_empresa and "; 
			else $onde = " u2.id_empresa = '".$controle_id_empresa."' and pi.id_empresa_resp='".$controle_id_empresa."' and u.id_empresa=ue.id_empresa and ";
...
Pedido;Valor Cobrado;Comissão;Data;Franquia;
';
					$cont_empresa++;
                }
