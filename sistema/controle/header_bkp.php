                    ...
                    <ul class="menuh">
                        ...
                        <li id="submenu-111" class="subv">
                            ...
                            <ul class="menuv">
                                ...
                                if ($permissao == 'TRUE') {
                                    ?>
                                    <li id="submenu-138"><a href="usuario.php"><img src="../images/icon/icon_usuario.png" style="border: 0" /> Colaboradores</a></li>
                                    <?
                                }
                                ?>
                                ...
                                if ($permissao == 'TRUE' and $controle_id_empresa == 1) {
                                    ...
                                    <? if ($controle_id_usuario == 1 or $controle_id_usuario == 56 or $controle_id_usuario == 2360) { ?>
                                        <li id="submenu-138"><a href="expansao_novos.php"><img src="../images/icon/icon_pedido.png" style="border: 0" /> Expansão Dir.</a></li>
										<li id="submenu-138"><a href="expansao_duplicidade.php"><img src="../images/icon/icon_pedido.png" style="border: 0" /> Expansão Duplic.</a></li>
										<li id="submenu-138"><a href="expansao_datacad.php"><img src="../images/icon/icon_pedido.png" style="border: 0" /> Expansão Data Cad.</a></li>
                                    <? }
                                } ?>
                            </ul>
                        </li>
