                    ...
                    <table width="100%" cellpadding="4" cellspacing="1" class="result_tabela">
                        ...
                        foreach ($buscapedido as $p) {
                            ...
                            if ($p->id_empresa_dir <> 0 and $p->id_empresa_dir != $controle_id_empresa) {
                                ...
                                $p_valor .= '<span class="formInfo"><a href="../help/pedido_dir.php?fantasia=' . $fantasia_dir . '" class="jTip" id="help_ativ' . $p->id_pedido_item . '" name="Direcionamento para outra franquia">?</a></span>';
                            }
                            $p_valor .= '</td>';
                            if ($busca_e_devedor == '')
