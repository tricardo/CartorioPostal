...
if ($submit) {//check for errors
    ...
    if ($errors != 1) {
        ...
        $id = $protestoDAO->inserir($p, $controle_id_empresa);
        $done = 1;
    }
    if ($errors) {
        ?>
                            ...
                            <table width="650" class="tabela">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input type="text" name="portador_nome"
                                                           value="<?= $p->portador_nome ?>" maxlength="40" style="width: 470px"
                                                           class="form_estilo"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div align="center">
                                            ...
                                            <input type="submit" name="cancelar" value="Cancelar" onclick="document.protesto_add.action='protesto.php'"	class="button_busca" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
