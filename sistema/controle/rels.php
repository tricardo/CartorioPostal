                    ...
                    <table cellpadding="4" cellspacing="1" class="result_tabela">
                        ...
                        if ($permissao == 'TRUE') { ?>
                            <tr>
                                ...
                                <td class="result_celula" align="center" nowrap>
                                    <a href="rel_geral.php?relatorio=geral"><img src="../images/botao_editar.png" title="Editar" border="0" /></a>
                                </td>
                            </tr>
                        <? } ?>
                        <?php
                        if ((verifica_permissao('Supervisor Atendimento', $controle_id_departamento_p, $controle_id_departamento_s) == 'TRUE')
                            ...
                            <tr>
                                ...
                                <td class="result_celula" align="center" nowrap>
                                    <a	href="rel_geral.php?relatorio=conciliação"><img	src="../images/botao_editar.png" title="Editar" border="0" /></a>					</td>
                            </tr>
                            <tr>
                                <td class="result_celula" nowrap>Atendimento / Financeiro</td>
                                <td class="result_celula" nowrap>Relatório de Pedidos Cancelados</td>
                                <td class="result_celula" align="center" nowrap>
                                    <a href="rel_geral.php?relatorio=cancelados"><img src="../images/botao_editar.png" title="Editar" border="0" /></a>					</td>
                            </tr>
                            <tr>
                                <td class="result_celula" nowrap>Atendimento / Financeiro</td>
                                <td class="result_celula" nowrap>Pedidos Cadastrados no Período</td>
                                <td class="result_celula" align="center" nowrap>
                                    <a href="gera_pedidos_cadastrados.php"><img src="../images/botao_editar.png" title="Editar" border="0" /></a>					</td>
                            </tr>
                            <tr>
                                <td class="result_celula" nowrap>Atendimento / Financeiro</td>
                                <td class="result_celula" nowrap>Pedidos Em Aberto por Período</td>
                                <td class="result_celula" align="center" nowrap>
                                    <a href="rel_geral.php?relatorio=em aberto"><img src="../images/botao_editar.png" title="Editar" border="0" /></a>					</td>
                            </tr>
                            <tr>
                                <td class="result_celula" nowrap>Atendimento / Financeiro</td>
                                <td class="result_celula" nowrap>Orçamentos Enviados</td>
                                <td class="result_celula" align="center" nowrap>
                                    <a href="rel_geral.php?relatorio=orçamento"><img src="../images/botao_editar.png" title="Editar" border="0" /></a>					</td>
                            </tr>
                            <tr>
                                <td class="result_celula" nowrap>Atendimento / Financeiro</td>
                        ...
                        if ($controle_id_empresa == 1 and $controle_depto_p['27'] == '1') {
                            ...
                            <tr>
                                ...
                                <td class="result_celula" align="center" nowrap>
                                    <a	href="gera_rel_franquia_adendo.php"><img src="../images/botao_editar.png" title="Editar" border="0" /></a>					</td>
                            </tr>
                        <?php } ?>
                    </table>
                </td>
