...
if ($permissao == 'FALSE' and $permissao_expansao == 'FALSE') {
...
?>
	...
	<td class="result_celula" align="center" nowrap><a href="envia_senha_usuario.php?id=' . $usuario->id_usuario . '"><img src="../images/botao_enviasenha.png" title="Enviar Senha" border="0"/></a></td>';
                            if ($permissao == 'TRUE') {
                                echo '<td class="result_celula" align="center" nowrap><a href="usuario_delete.php?id=' . $usuario->id_usuario . '" onclick="return confirm(\'Deseja excluir o registro?\')"><img src="../images/botao_delete.png" title="Excluir" border="0"/></a></td>';
                            }
                            echo '</tr>';
                        }
                        echo $p_valor;
