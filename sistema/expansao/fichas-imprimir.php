...
<table width="70%" cellpadding="4" cellspacing="1" class="result_tabela" style="left:35%;margin-left:-17.5%;position:relative;text-transform:uppercase">
	<tr>
		<td class="result_menu" style="font-weight:bold" colspan="4">Histórico</td>
	</tr>
	<tr>
		<td class="result_menu" style="font-weight:bold">Data</td>
		<td class="result_menu" style="font-weight:bold">Status</td>
		<td class="result_menu" style="font-weight:bold">Consultor</td>
		<td class="result_menu" style="font-weight:bold">Obs.</td>
	</tr>
	<?$historico = $expansao->listaHistoricoPrint($c->id_ficha); 
	...
	<tr>
		...
		<td class="result_celula"><?
			...
			echo $st[0]->status;
		?></td>
		<td class="result_celula"><?$us = $expansao->pega_usuario($historico[$i]->id_user_alt);
			echo (strlen($us[0]->nome) > 0) ? $us[0]->nome : 'Cadastrado pelo Sistema'; ?></td>
		<td class="result_celula"><?=$historico[$i]->observacao?></td>
	</tr>
	<? } ?>
</table><br /><br />
