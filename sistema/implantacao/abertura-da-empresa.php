...
<tr id="tr_implantacao">
	...
	<td style="width:200px;">&nbsp;Data da Aprovação</td>
</tr>
<?
$dt = $franquia->checklist(6, 1); $j = 0; $i = 0;
foreach ($dt as $f) { 
	$dt1 = $franquia->checklist_edit(6,$f->id_empresa_chk,$c->id_empresa); $data = '';
	if(count($dt1) > 0){
...
<tr>
	<td colspan="4">
		<? if($progresso < 100){?>
			<input type="button" value="Editar" class="button_busca" style="margin-left:10px" onclick="alterar_implantacao(6)" />
