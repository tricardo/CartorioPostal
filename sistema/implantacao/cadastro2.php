...
<input type="text" id="royalties" name="royalties"	value="<?= $emp->royalties ?>" style="width: 50px" 
...
<input type="text" name="imposto" value="<?= $emp->imposto ?>" id="imposto" style="width: 50px" 
