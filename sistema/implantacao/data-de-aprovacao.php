...
if($permissao_admin == 'FALSE' && $passo < 100){
	echo '<br /><br /><span style="color:#FF0000">Você deve finalizar o passo 2 para dar continuidade a este 
		passo!</span><br /><br />&nbsp;';
	exit;
} else { 
	...
	$passo = (($progresso[1] * 100) / $progresso[0]);
	if($permissao_admin == 'FALSE' && $passo < 100){
		echo '<br /><br /><span style="color:#FF0000">Você deve finalizar o passo anterior para dar continuidade a este 
				passo!</span><br /><br />&nbsp;';
		exit;
	}
}
