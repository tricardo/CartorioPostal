<?php
	class classQuery_Outros{
		...
		function classQuery_Outros(){
			$this->host = "localhost";
			$this->user = "omelhord_user";
			$this->pass = "we23we23we23";
			$this->db	= "omelhord_bairro";
		}
	...
	$objQuery_Outros = new classQuery_Outros();
?>