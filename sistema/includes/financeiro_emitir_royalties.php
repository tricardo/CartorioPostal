...
if ($controle_id_empresa == 1) {
    ...
    if (isset($submit_financeiro_emitir_royalties)) {
        ...
        $html = 'Consoante a assinatura do contrato de franquia firmado entre Vossa Senhoria e a Franqueadora, informamos que o boleto para pagamento dos Royalties, bem como o valor e dados para dep�sito do FPP, apurados no m�s anterior est�o dispon�veis para download no sistema.<br><br>
Para acess�-lo ser� necess�rio clicar no menu:<br>
<b>INICIAR > REL�T�RIOS > RELAT�RIO DE ROYALTIES E FATURAMENTO</b><br><br>

E baixar o boleto e o relat�rio para conferencia dos valores e faturamento.

Refor�amos nossa parceria.<br><br>
Atenciosamente,<br>
        ...
        if (count($error) == 0) {
            ...
            foreach ($lista as $item) {
                ...
                if ($retorno > 0) {
                    ...
                    $mailer->SEND('financeiro@cartoriopostal.com.br', $AddAddress, $AdsdCC, $AddBCC, '', 'Royalties e FPP Cart�rio Postal', $html);
                }
            }
                    ...
                    <td id="td_implantacao">
                        ...
                        <div class="divBancoBradesco"
                            ...
                            <select name="instrucao1" id="instrucao1"
                                ...
                                <option value="8">N�o cobrar juros de mora</option>
                                <option value="9">N�o receber ap�s o vencimento</option>
                                <option value="11">N�o receber ap�s o 8� dia do vencimento</option>
                                <option value="12">Cobrar encargos ap�s o 5� dia do vencimento</option>
                                <option value="13">Cobrar encargos ap�s o 10� dia do vencimento</option>
                                <option value="14">Cobrar encargos ap�s o 15� dia do vencimento</option>
                            </select>
                            <font style="float:left;color:#FF0000;">*</font>
                            <br/>
                        ...
                        <select name="especie" id="especie"
                            ...
                            <option value="2">Nota Promiss�ria</option>
                            <option value="3">Nota de Seguro</option>
                            <option value="4">Cobran�a Seriada</option>
                            <option value="5">Recibo</option>
                            <option value="10">Letras de C�mbio</option>
                            <option value="11">Nota de D�bito</option>
