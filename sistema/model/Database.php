 ...
 * nenhma requisiï¿½ï¿½o ao BD deve ser executada fora dessa classe
 * controla a conexï¿½o com o banco, atravï¿½s da classe PDOSingleton, criando apenas uma conexï¿½o
 *
 * @author Caio M Nardi
 * @since 01/03/2008
 */
class Database {
	...
	/**
	 * funï¿½ï¿½o para exibir a paginaï¿½ï¿½o
	 */
