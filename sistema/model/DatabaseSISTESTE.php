<?php
require_once('PDOSingletonSISTESTE.php');
...
class DatabaseSISTESTE {
	...
	protected function connect() {
		try {
			$this->con = PDOSingletonSISTESTE::getInstance($this->dbType.":host=".$this->host.";dbname=".$this->db, $this->user, $this->password);
		}
		catch (Exception $e ) {
