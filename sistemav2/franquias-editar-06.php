...
$carrega   = 1;
$passo     = 3;
if($_POST AND isset($_POST['f_ponto'])){
...
<form enctype="multipart/form-data" method="post" id="form6" action="<?=$link?>&opcoes_form=6">
    <h3>informações sobre o ponto</h3>
    <dl>
        <table class="table1">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="5"><strong>Progresso da Implantação:</strong></td>
                </tr>
                <tr>
                    <td colspan="5">
        ...
        <div class="buttons">
            ...
            <input type="submit" value="editar &rsaquo;&rsaquo;" onclick="Validar(1)" <?=($progresso == 100 AND $controle_id_usuario != 1) ? 'disabled="disabled"' : ''?> name="f_ponto">
        </div>
    </dl>
</form>
<?php if(isset($_POST['f_ponto'])){ ?>
    <div class="msgbox">
