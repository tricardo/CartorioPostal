...
$carrega   = 1;
$passo     = 6;
if($_POST AND isset($_POST['f_abertura'])){
...
<form enctype="multipart/form-data" method="post" id="form8" action="<?=$link?>&opcoes_form=8">
    ...
    <dl>
        ...
        <div class="buttons">
            ...
            <input type="submit" value="editar &rsaquo;&rsaquo;" onclick="Validar(1)" <?=($progresso == 100 AND $controle_id_usuario != 1) ? 'disabled="disabled"' : ''?> name="f_abertura">
        </div>
    </dl>
</form>
<?php if(isset($_POST['f_abertura'])){ ?>
    <div class="msgbox">
