...
$carrega   = 1;
$passo     = 8;
if($_POST AND isset($_POST['f_treinamento'])){
...
<form enctype="multipart/form-data" method="post" id="form9" action="<?=$link?>&opcoes_form=9">
    <h3>treinamento</h3>
    <dl>
        <table class="table1">
            <thead>
        ...
        <div class="buttons">
            ...
            <input type="submit" value="editar &rsaquo;&rsaquo;" onclick="Validar(1)" <?=($progresso == 100 AND $controle_id_usuario != 1) ? 'disabled="disabled"' : ''?> name="f_treinamento">
        </div>
    </dl>
</form>
<?php if(isset($_POST['f_treinamento'])){ ?>
    <div class="msgbox">
