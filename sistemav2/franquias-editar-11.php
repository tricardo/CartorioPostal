...
$carrega   = 1;
$passo     = 10;
if($_POST AND isset($_POST['f_inicio_ativ'])){
...
<form enctype="multipart/form-data" method="post" id="form11" action="<?=$link?>&opcoes_form=11">
    ...
    <dl>
        <table class="table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=$f->item?></td>
                    <td><input value="<?=$data1?>" <?=($progresso == 100 AND $controle_id_usuario != 1) ? 'disabled="disabled"' : ''?> id="datah1<?=$f->id_empresa_chk?>" name="datah1<?=$f->id_empresa_chk?>" placeholder="Data" class="data" type="text"></td>
                </tr>
                <?php }  ?>
                <tr>
        ...
        <div class="buttons">
            ...
            <input type="submit" value="editar &rsaquo;&rsaquo;" onclick="Validar(1)" <?=($progresso == 100 AND $controle_id_usuario != 1) ? 'disabled="disabled"' : ''?> name="f_inicio_ativ">
        </div>
    </dl>
</form>
