...
<script>
    menu(3,'bt-02');
    $('#titulo').html('cadastros &rsaquo;&rsaquo; pedidos');
...
<div class="content-list-table">   
    <h3>
        ...
        <p>Até que esta página seja concluída, utilize o sistema antigo <a href="../sistema/controle/pedido.php" target="_blank">clicando aqui.</a></p>
    </h3>
</div>
